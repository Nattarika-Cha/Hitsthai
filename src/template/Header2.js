                                                ...
                                                <Row id="div-sidebar7">
                                                    <Collapse expandIcon={() => <UserOutlined />} >
                                                        <Panel showArrow={false} header="ตั้งค่า" key="1" style={{fontSize:"Medium", backgroundColor: "#ffffff"}}>
                                                            <div id="cat-content"><NavLink to="/MemberPoint" id="sub-cat" onClick={() => this.onSetSidebarOpen(false)}> <CaretRightOutlined style={{ paddingRight: "1%" }} /> ยอดเงินสะสม</NavLink></div>
